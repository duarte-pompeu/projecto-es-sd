...
public class AssignBinaryToCellTest extends BubbleDocsServiceTest {
	...
	assertTrue("Content not set with a binary function", ( CS_SHEET.getContent(USER, CELL_ID0) instanceof BinaryFunction));
	...
	public void NoSession(){
		...
		AssignBinaryToCell service = new AssignBinaryToCell( CELL_ID0,
		Function_Expression, 
		CS_ID, 
		bad_token);
		service.execute();
